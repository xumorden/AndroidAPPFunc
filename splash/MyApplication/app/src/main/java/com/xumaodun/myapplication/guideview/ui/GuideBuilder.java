package com.xumaodun.myapplication.guideview.ui;
 ...
 * { com.blog.www.guideview.Component},设置文字或者图片等
 * { com.blog.www.guideview.Component#getView(android.view.LayoutInflater)}
 * . 所有的图片文字都是相对于targetRect来定义的。可以设定额外的x，
 * { com.blog.www.guideview.Component#getXOffset()} ;y偏移量,
 * { com.blog.www.guideview.Component#getYOffset()}。
 * </p>
 * <p>
