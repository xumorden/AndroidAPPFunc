...
/**
 * 遮罩系统的封装 <br>
 * 外部需要调用{ com.blog.www.guideview.GuideBuilder}来创建该实例，实例创建后调用
 * { #show(Activity)} 控制显示； 调用 {@link #dismiss()}让遮罩系统消失。 <br>
 *
 * Created by binIoter
 */
public class Guide implements View.OnKeyListener, View.OnClickListener {
   ...
   *
   *  com.blog.www.guideview.GuideBuilder
   */
  Guide() {
  }
  ...
  /**
   * 显示该遮罩, <br>
   * 外部借助{ com.blog.www.guideview.GuideBuilder}
